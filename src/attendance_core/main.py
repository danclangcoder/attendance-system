...
if __name__ == '__main__':
    ...
    Desktop 2D Barcode Reader (QR)
        attendance_log.record(qr_scanner, users_file=USERS_FILE, logs_file=LOGS_FILE, sha=sha_256)
    '''

    '''
    Webcam
        attendance_log.record(qr_camera, users_file=USERS_FILE, logs_file=LOGS_FILE, sha=sha_256)
    '''
